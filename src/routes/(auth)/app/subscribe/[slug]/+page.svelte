    ...
    <header class="sub-org-header" style="animation-delay: 0ms">
      <div class="sub-org-top">
        ...
        <div class="sub-org-info">
          ...
          <div class="sub-org-meta">
            {#if data.org.status}
              <span
                class="sub-org-status sub-status-{data.org.status || 'active'}"
                >{data.org.status}</span
              >
            {/if}
      ...
      {#if data.existingMembership}
        <div class="sub-membership-badge">
          ...
          <span
            >You're a verified <strong>{data.existingMembership.role}</strong> of
            this organization</span
          >
        </div>
      {/if}
    </header>
        ...
        {#if subscribeSuccess}
          ...
          <div class="sub-success-state">
            ...
            <p class="sub-success-p">
              You'll now receive route updates from <strong
                >{data.org.name}</strong
              >. Updates include schedule changes, route modifications, fare
              adjustments, and service alerts.
            </p>
          </div>
        {:else}
          <div class="sub-panel-header">
            <div>
              ...
              <p class="sub-panel-desc">
                Choose which routes to follow. You'll get notified about
                schedule changes, detours, fare updates, and service alerts.
              </p>
            </div>
          </div>
          ...
          {#if data.routes.length > 0}
            <div class="sub-route-controls">
              ...
              <span class="sub-route-count"
                >{selectedRoutes.size} of {data.routes.length} selected</span
              >
            </div>
            ...
            <div class="sub-route-list">
              {#each data.routes as route, i}
                ...
                >
                  <div
                    class="sub-checkbox"
                    class:sub-checked={selectedRoutes.has(route.id)}
                  >
                  ...
                  <div class="sub-route-info">
                    ...
                    <div class="sub-route-detail">
                      {formatRoute(route.route)}
                    </div>
                  </div>
                  {#if route.created_at}
                    <span class="sub-route-time"
                      >{timeAgo(route.created_at)}</span
                    >
                  {/if}
                </button>
              {/each}
          ...
          {:else}
            <div class="sub-empty-routes">
              ...
              <p>
                No routes published yet for this organization. Subscribe to all
                routes to get notified when new ones are added.
              </p>
            </div>
          {/if}
            ...
            {#if showVehicles}
              <div class="sub-vehicles-grid sub-slide-in">
                {#each data.vehicles as v}
                  <div
                    class="sub-vehicle-chip"
                    class:sub-vehicle-active={v.active}
                  >
                    ...
                    {/if}
                    <span
                      class="sub-vehicle-dot"
                      class:sub-vdot-on={v.active}
                      class:sub-vdot-off={!v.active}
                    ></span>
                  </div>
                {/each}
              </div>
          ...
          >
            ...
            <button
              type="submit"
              class="sub-btn-subscribe"
              disabled={isSubmitting ||
                (!selectAll && selectedRoutes.size === 0)}
            >
              {#if isSubmitting}
              ...
              {:else}
                ...
                Subscribe to {selectAll ? "All" : selectedRoutes.size} Route{selectedRoutes.size !==
                  1 || selectAll
                  ? "s"
                  : ""}
              {/if}
      ...
      <div class="sub-panel sub-slide-in" style="animation-delay: 120ms">
        {#if verifySuccess}
          <div class="sub-success-state">
            ...
            <p class="sub-success-p">
              Your request has been sent to <strong>{data.org.name}</strong> admins
              for review. You'll be notified once your identity is verified and your
              role is activated.
            </p>
          </div>
        ...
        {:else if data.existingMembership}
          ...
          <div class="sub-verified-state">
            ...
            <p class="sub-verified-p">
              You're an active <strong>{data.existingMembership.role}</strong>
              member of {data.org.name}. Your identity is confirmed and your
        ...
        {:else}
          ...
          <div class="sub-panel-header">
            <div>
              ...
              <p class="sub-panel-desc">
                Request verification as a member of <strong
                  >{data.org.name}</strong
                >. This links your profile to the organization and unlocks
                role-specific permissions — route access, fleet controls,
                ticketing, and more.
              </p>
            </div>
          </div>
          ...
          <div class="sub-how-it-works">
            <div class="sub-step">
              ...
              <div class="sub-step-text">
                ...
                <span
                  >Choose the role that matches your position within the
                  organization</span
                >
              </div>
            </div>
            ...
            <div class="sub-step">
              ...
              <div class="sub-step-text">
                ...
                <span
                  >An org admin reviews your request and verifies your identity</span
                >
              </div>
            </div>
            <div class="sub-step-connector"></div>
            <div class="sub-step">
              ...
              <div class="sub-step-text">
                ...
                <span
                  >Once approved, your actor role and permissions go live
                  instantly</span
                >
              </div>
            </div>
          ...
          >
            <div class="sub-field">
              ...
              <div class="sub-role-grid">
                {#each data.roles as role}
                  <label
                    class="sub-role-option"
                    class:sub-role-selected={selectedRole === role.id}
                  >
                    <input
                      type="radio"
                      name="role"
            ...
            <div class="sub-field">
              <label for="verify-note" class="sub-label"
                >Additional Context <span class="sub-optional">(optional)</span
                ></label
              >
              <textarea
                id="verify-note"
            ...
            <div class="sub-identity-summary">
              <div class="sub-id-row">
                ...
                <span class="sub-id-value"
                  >{data.profile?.full_name || "Unknown"}</span
                >
              </div>
              <div class="sub-id-row">
              ...
              {#if selectedRole}
                <div class="sub-id-row">
                  ...
                  <span class="sub-id-value sub-id-accent"
                    >{roleLabel(selectedRole)}</span
                  >
                </div>
              {/if}
            </div>
...
<style>
  ...
  .sub-textarea:focus {
    border-color: var(--verify-border);
    box-shadow: 0 0 0 3px var(--verify-soft);
  }
  ...
  .sub-btn-verify:hover:not(:disabled) {
    transform: translateY(-1px);
    box-shadow: 0 6px 24px var(--verify-glow);
  }
  .sub-btn-verify:disabled {
    opacity: 0.5;
    cursor: not-allowed;
  }
