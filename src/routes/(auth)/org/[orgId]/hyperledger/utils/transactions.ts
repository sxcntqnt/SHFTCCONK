...
export async function unassignDriver(
  ...
  return submit(ctx, "UnassignDriver", [
    vehicleId,
    driverUserId,
...
export async function recordWalletTopUp(
  ...
  return submit(ctx, "RecordWalletTopUp", [
    walletId,
    String(amount),
    currency,
    reference,
...
export async function reconcileTripPayment(
  ...
  return submit(ctx, "ReconcileTripPayment", [
    tripId,
    walletId,
    String(amount),
    method,
...
export async function deductDriverPenalty(
  ...
  return submit(ctx, "DeductDriverPenalty", [
    driverUserId,
    walletId,
    String(amount),
    reason,
...
export async function updateDeviceLocation(
  ...
  return submit(ctx, "UpdateDeviceLocation", [
    deviceId,
    lat,
    lng,
    new Date().toISOString(),
