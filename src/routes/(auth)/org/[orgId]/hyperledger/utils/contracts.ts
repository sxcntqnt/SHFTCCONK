...
export const WRITE_CONTRACTS: Record<string, ContractDef> = {
  ...
  LogTripCompletion: {
    ...
    argShape: ['vehicleId', 'driverUserId', 'distanceKm', 'startTime', 'endTime'],
  },
...
export const READ_CONTRACTS: Record<string, ContractDef> = {
  // ── Fleet ──────────────────────────────────────────────────────────────────
  GetVehicleStatus:    { chaincode: CHAINCODES.FLEET, fn: 'GetVehicleStatus',    requiredRoles: [ROLES.DRIVER, ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['vehicleId'] },
  GetVehicleHistory:   { chaincode: CHAINCODES.FLEET, fn: 'GetVehicleHistory',   requiredRoles: [ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['vehicleId'] },
  GetFleetSummary:     { chaincode: CHAINCODES.FLEET, fn: 'GetFleetSummary',     requiredRoles: [ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['orgId'] },
  GetDriverRecord:     { chaincode: CHAINCODES.FLEET, fn: 'GetDriverRecord',     requiredRoles: [ROLES.DRIVER, ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['driverUserId'] },
  GetDriverTrips:      { chaincode: CHAINCODES.FLEET, fn: 'GetDriverTrips',      requiredRoles: [ROLES.DRIVER, ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['driverUserId', 'fromDate', 'toDate'] },
  GetActiveAssignment: { chaincode: CHAINCODES.FLEET, fn: 'GetActiveAssignment', requiredRoles: [ROLES.DRIVER, ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['vehicleId'] },

  // ── Finance ────────────────────────────────────────────────────────────────
  GetWalletBalance:    { chaincode: CHAINCODES.FINANCE, fn: 'GetWalletBalance',  requiredRoles: [ROLES.DRIVER, ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['walletId'] },
  GetWalletHistory:    { chaincode: CHAINCODES.FINANCE, fn: 'GetWalletHistory',  requiredRoles: [ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['walletId', 'fromDate', 'toDate'] },
  GetPaymentRecord:    { chaincode: CHAINCODES.FINANCE, fn: 'GetPaymentRecord',  requiredRoles: [ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['paymentId'] },

  // ── Compliance ─────────────────────────────────────────────────────────────
  GetComplianceEvents: { chaincode: CHAINCODES.COMPLIANCE, fn: 'GetComplianceEvents', requiredRoles: [ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['orgId', 'fromDate', 'toDate'] },
  GetComplianceStatus: { chaincode: CHAINCODES.COMPLIANCE, fn: 'GetComplianceStatus', requiredRoles: [ROLES.DRIVER, ROLES.FLEET_MANAGER, ROLES.ORG_ADMIN], argShape: ['entityId'] },

  // ── Audit ──────────────────────────────────────────────────────────────────
  GetAuditLog:         { chaincode: CHAINCODES.FLEET, fn: 'GetAuditLog', requiredRoles: [ROLES.ORG_ADMIN], argShape: ['orgId', 'fromDate', 'toDate'] },
};