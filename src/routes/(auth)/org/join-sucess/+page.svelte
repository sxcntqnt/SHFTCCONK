...
<div
  class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-6"
>
  <div
    class="card bg-white rounded-3xl shadow-2xl p-12 max-w-md text-center animate-in zoom-in"
  >
    <div
    ...
    <p class="text-lg text-gray-700 mb-8">
      ...
      Your owner profile has been created and is pending admin approval (usually 24-48
      hours).
    </p>

    <div class="bg-gray-50 p-6 rounded-2xl mb-8">
      <p class="text-sm text-gray-600">Your SACCO Join Code (for reference):</p>
      <div class="text-2xl font-mono font-bold text-blue-700 mt-2">
        {data.joinCode}
      </div>
    </div>
    ...
    <a
      href=""
      class="btn bg-green-600 hover:bg-green-700 text-white rounded-full h-14 px-10 text-lg inline-block"
    >
      Go to Dashboard
    </a>
  </div>
