...
const QUERY_MAP: Record<string, { chaincode: string; allowedRoles: string[] }> =
  {
    ...
    GetVehicleHistory: {
      ...
      allowedRoles: ["driver", "fleet-manager", "org-admin", "platform-admin"],
    },
    GetVehicleStatus: {
      chaincode: "fleet-contract",
      allowedRoles: ["driver", "fleet-manager", "org-admin"],
    },
    GetFleetSummary: {
      chaincode: "fleet-contract",
      allowedRoles: ["fleet-manager", "org-admin"],
    },
    ...
    GetComplianceEvents: {
      ...
      allowedRoles: ["fleet-manager", "org-admin", "platform-admin"],
    },
    GetComplianceStatus: {
      chaincode: "compliance-contract",
      allowedRoles: ["driver", "fleet-manager", "org-admin"],
    ...
    GetAuditLog: {
      chaincode: "fleet-contract",
      allowedRoles: ["org-admin", "platform-admin"],
    },
  }
...
export const GET: RequestHandler = async ({ url, params, locals }) => {
  ...
  if (argsParam) {
    try {
      ...
      throw error(
        400,
        'Invalid "args" param — must be a JSON-encoded array e.g. ?args=["v123"]',
      )
    }
  }
