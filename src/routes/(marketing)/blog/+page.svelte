...
<svelte:head>
  ...
  <meta
    name="description"
    content="Insights, updates, and stories from the team building smarter matatu transit in Nairobi."
  />
</svelte:head>
...
<div class="blog-root">
  ...
  <header class="blog-header">
    <div class="blog-header-inner">
      ...
      <h1 class="blog-title">
        {blogInfo.name.split(" ")[0]}
        <em>{blogInfo.name.split(" ").slice(1).join(" ") || "Blog"}</em>
      </h1>
      <p class="blog-subtitle">
        Insights, product updates, and stories from the team building smarter
        matatu transit in Nairobi.
      </p>
    ...
    {#if featuredPost}
      <a href={featuredPost.link} class="featured-post">
        ...
        <div class="featured-content">
          <div class="post-date">
            {featuredPost.parsedDate?.toLocaleDateString("en-US", {
              month: "long",
              day: "numeric",
              year: "numeric",
            })}
    ...
    {:else if !featuredPost}
      <div class="posts-grid">
        <div class="empty-state">
          <p>
            No posts yet. Check back soon — we're working on something worth
            reading.
          </p>
        </div>
      </div>
...
<style>
  ...
  .featured-accent {
    background:
      linear-gradient(
        160deg,
        rgba(242, 101, 34, 0.7) 0%,
        rgba(217, 86, 24, 0.4) 60%,
        rgba(10, 10, 12, 0) 100%
      ),
      var(--ink-3);
    min-height: 340px;
