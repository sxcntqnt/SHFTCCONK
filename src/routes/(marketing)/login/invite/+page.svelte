...
<div class="invite-wrap">
  <div class="page-header">
    ...
    <p class="page-sub">
      Your role and organisation are pre-assigned in your invitation. Enter the
      code from your email to continue.
    </p>
  </div>
  ...
  <div class="info-card">
    ...
    <p>
      <strong>Your role is set by your organisation administrator</strong> — not by
      this form. You cannot change it during sign-up. Contact your sacco chair or
      Matatu Pulse support if your access is incorrect after signing in.
    </p>
  </div>
  ...
  <div>
    ...
    />
    <p class="input-hint">
      Find your code in the invitation email from Matatu Pulse or your sacco
      administrator.
    </p>
  </div>
  ...
  <div class="how-it-works">
    ...
    <div class="steps">
      {#each [{ n: "1", text: "Your <strong>sacco chair or Matatu Pulse</strong> creates your account and sets your role." }, { n: "2", text: "You receive an <strong>email with an invitation code</strong> and a direct link." }, { n: "3", text: "You redeem the code here and <strong>set your own password</strong>." }, { n: "4", text: "Your role and organisation context are <strong>active immediately</strong> after sign-in." }] as s}
        <div class="step">
  ...
  <div class="auth-footer">
    <div class="auth-footer-row">
      Already set a password? <a href="/login/sign_in">Sign in instead</a>
    </div>
    <div class="auth-footer-row">
      No invitation yet? <a href="/contact_us?type=partnership"
        >Request access for your sacco</a
      >
    </div>
    <div class="auth-footer-row">
      Wrong portal? <a href="/login">Back to all sign-in options</a>
    </div>
  </div>
</div>
