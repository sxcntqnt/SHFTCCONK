...
<div class="login-root">
  ...
  <div class="brand-panel">
    ...
    <div class="brand-top">
      ...
      <p class="brand-sub">
        Real-time GPS tracking, arrival alerts, and fleet intelligence — built
        for the roads that keep Nairobi moving.
      </p>

      <!-- Stat cards -->
      <div class="brand-stats">
        {#each [{ strong: "60,000+", label: "daily active riders", icon: `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>` }, { strong: "9 minutes", label: "average wait time saved per trip", icon: `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>` }, { strong: "340+ vehicles", label: "tracked live across 12 partner saccos", icon: `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13"/><path d="M16 8h4l3 3v5h-7z"/></svg>` }] as s}
    ...
    <div class="brand-bottom">
      <div class="brand-testimonial">
        ...
        <p class="testi-quote">
          I no longer wait blindly at the stage. I leave only when the matatu is
          close — saved at least 45 minutes every single day.
        </p>
    ...
    <div class="form-wrap">
      ...
      {#if isEurope}
        <div class="cookie-notice">
          ...
          <p class="cookie-text">
            Signing in uses cookies to maintain your session securely. By
...
<style>
  ...
  .brand-panel::before {
    ...
    background:
      radial-gradient(
        ellipse 90% 70% at -10% 110%,
        rgba(242, 101, 34, 0.22) 0%,
        transparent 60%
      ),
      radial-gradient(
        ellipse 60% 50% at 110% -10%,
        rgba(0, 176, 155, 0.08) 0%,
        transparent 55%
      ),
      radial-gradient(
