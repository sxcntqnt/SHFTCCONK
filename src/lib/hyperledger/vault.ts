...
const ENCRYPTION_KEY = Buffer.from(env.FABRIC_KEY_ENCRYPTION_SECRET ?? '', 'hex'); // 32 bytes
 ...
 */
export async function loadIdentity(userId: string): Promise<FabricIdentity | null> {
